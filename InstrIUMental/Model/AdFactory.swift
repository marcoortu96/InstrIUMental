...
public class AdFactory {
    ...
    init() {
        ...
        ads.append(Ad(id: 2, title: "CORT GB75",text: "Vendo basso cort gb 75 5 corde in ottime condizioni. Disponibile a qualsiasi prova.",price: 350.00, category:"Bassi", author: "ramino", image: [UIImage(named: "img4")!, UIImage(named: "img5")!, UIImage(named: "img6")!], date: "2017-12-24", region : "Lombardia", latitude: 45.452082, longitude: 9.163186))
