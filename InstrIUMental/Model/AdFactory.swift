...
public class AdFactory {
    ...
    init() {
        ...
        ads.append(Ad(id: 3, title: "UFIP RIDE/PING",text: "Vendo piatto UFIP Ping/ride (52cm)come da foto(asta non inclusa),vintage anni 80 suono pulito e brillante a euro100 escluso spese di spedizione a carico del compratore! (NO PERMUTE NON TRATTABILI).",price: 100.00, category:"Batterie", author: "colonello", img: ["img10","img11","img12"], date: "2018-10-07"))
